<style>
    ...
    .text_content2 {position:relative; padding-bottom:360px;margin: 60px 0 0 40px; border-top:1px solid #e4e4e4;width:635px;}
    .text_pic{position:absolute; right:0; bottom:40px;}
    .text_pic img{width:100px;}
        ...
        <div class="text_content2" id="about_more">
            <div class="text_sum">
                <div class="text_singel">
                    <h3>对外合作</h3>
                    <p>联系人:吕先生</p>
                    <p>Email:lvchao@xiaomi.com</p>
                </div>
                <div class="text_singel">
                    <h3>反馈建议</h3>
                    <p>Email:shouquanhezuo@xiaomi.com</p>
                </div>
                <div class="text_singel">
                    <h3>侵权举报</h3>
                    <p>联系人:袁先生</p>
                    <p>Email:yuansihui@xiaomi.com</p>
                </div>
                <div class="text_singel">
                    <h3>联系我们</h3>
                    <p>地址:北京市海淀区清河中街68号 华润五彩城写字楼</p>
                    <p>邮编:100085</p>
                    <p>传真:0160606666-1101</p>
                </div>
            </div>
            <div class="text_pic">
